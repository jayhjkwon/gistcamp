define(function(require){
  ...
  GistItemView  = Marionette.ItemView.extend({
    ...
    initialize: function(){
      var self = this;
      _.bindAll(this, 'onUserFollowChanged', 'onGistItemSelected', 'onTagChanged', 'onClose', 'setIsSelectedGistFalse', 'onFollowUserClicked', 'onCommentDeleted', 'onCommentAdded', 'onStarChanged');
      ...
      this.subscriptionUserFollow = postalWrapper.subscribe(constants.USER_FOLLOW, this.onUserFollowChanged);
      this.subscriptionUserUnFollow = postalWrapper.subscribe(constants.USER_UNFOLLOW, this.onUserFollowChanged);
    },
