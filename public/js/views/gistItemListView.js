define(function(require) {
  ...
  $ = require('jquery'),
    ...
    GistItemListView = Marionette.CollectionView.extend({
      ...
      initialize: function() {
        var self = this;
        _.bindAll(this, 'getGistList', 'onRender', 'onScroll', 'handleGist',
          'setFileContent', 'onClose');
        this.isLoading = false;
        this.xhrs.length = 0;
        this.spinner = new Spinner();
        this.subscribe = postalWrapper.subscribe(constants.WATCH_ITEM_CLICK,
          function(model) {
      ...
      getGistList: function(mode, options) {
        ...
        gistItemList.fetch({
          ...
          .done(function(res) {
            ...
            async.eachLimit(res.data, 3, self.handleGist, function(error,
              result) {
