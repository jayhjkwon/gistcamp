define(function(require){ 
  ...
  FooterView = Marionette.ItemView.extend({
    ...
    initialize: function(){
      _.bindAll(this, 'toggleCommentRegion', 'popupWindow', 'deleteTag', 'sharePocket', 'shareEverNote', 'onTagItemHover', 'shareWo', 'shareGg', 'shareFB', 'shareTW', 'shareFB', 'initializePopOverTag', 'onItemSelected', 'star', 'createTag', 'loading', 'onBtnCommentClick', 'onRoomCreated', 'tagOnGist', 'onCommentDeleted', 'onCommentAdded', 'onTagCollectionChange', 'initializePopOverShare');
      ...
      this.subscriptionCommentRegion = postalWrapper.subscribe(constants.HIDE_COMMENT_REGION, this.hideCommentRegion);
